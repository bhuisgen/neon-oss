...
const (
	headerModuleID module.ModuleID = "server.middleware.header"
	headerLogger   string          = "server.middleware.header"
)
...
func (m *headerMiddleware) Mount() error {
	return nil
}

// Unmount unmounts the middleware.
func (m *headerMiddleware) Unmount() {
}
...
var _ core.ServerMiddlewareModule = (*headerMiddleware)(nil)
