...
const (
	staticModuleID           module.ModuleID = "server.middleware.static"
	staticLogger             string          = "server.middleware.static"
...
func (m *staticMiddleware) Mount() error {
	return nil
}

// Unmount unmounts the middleware.
func (m *staticMiddleware) Unmount() {
}
...
var _ core.ServerMiddlewareModule = (*staticMiddleware)(nil)
